...
class HorarioView(View):
    ...
    def __init__(self, parent=None, stand_alone=True):
        ...
        ui = os.path.join(_config.get_data_path(), 'ui', 'HorarioDialog.ui')
        if not os.path.exists(ui):
            ui = None
        
        # Top window/widget check.
        if stand_alone: top_widget = 'horario_dialog'
    ...
    def run(self):
        ...
        res = self['horario_dialog'].run()
        self['horario_dialog'].destroy()
        return res
