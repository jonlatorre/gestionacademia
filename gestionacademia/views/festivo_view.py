...
class FestivoView(View):
    ...
    def __init__(self, parent=None, stand_alone=True):
        ...
        ui = os.path.join(_config.get_data_path(), 'ui', 'FestivoDialog.ui')
        if not os.path.exists(ui):
            ui = None
        
        # Top window/widget check.
        if stand_alone: top_widget = 'festivo_dialog'
    ...
    def run(self):
        ...
        res = self['festivo_dialog'].run()
        self['festivo_dialog'].destroy()
        return res
